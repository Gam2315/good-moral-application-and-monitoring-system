...
// Temporarily remove guest middleware to fix auth issues
...
// Temporarily remove auth middleware to fix auth issues
...
// Receipt validation dashboard routes
Route::prefix('admin/receipt-validation')->group(function () {
  Route::get('/dashboard', [\App\Http\Controllers\ReceiptValidationController::class, 'dashboard'])
    ->name('admin.receipt-validation.dashboard');
  Route::post('/test', [\App\Http\Controllers\ReceiptValidationController::class, 'testValidation'])
    ->name('admin.receipt-validation.test');
  Route::get('/stats', [\App\Http\Controllers\ReceiptValidationController::class, 'getValidationStats'])
    ->name('admin.receipt-validation.stats');
  Route::post('/export-logs', [\App\Http\Controllers\ReceiptValidationController::class, 'exportLogs'])
    ->name('admin.receipt-validation.export');
});

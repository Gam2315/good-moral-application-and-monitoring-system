...
class CourseHelper
{
    ...
    public static function getCoursesByDepartment(): array
    {
        ...
        foreach ($courses as $deptCode => $deptCourses) {
            $coursesByDept[$deptCode] = array_keys($deptCourses->toArray());
        }
    ...
    {
        $course = Course::where('course_code', $courseCode)->active()->first();
    ...
    {
        $course = Course::where('department', $deptCode)->active()->first();
        return $course ? $course->department_name : $deptCode;
    }
    ...
    {
        return Course::byDepartment($deptCode)
            ->active()
            ->ordered()
    ...
    {
        return Course::where('course_code', $courseCode)->active()->exists();
    }

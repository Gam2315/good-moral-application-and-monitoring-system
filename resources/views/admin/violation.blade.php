<x-dashboard-layout>
  ...
  <div class="header-section">
    ...
    <!-- Search Form -->
    <form method="GET" action="{{ route('violationsearch') }}" style="margin-bottom: 0; padding: 24px; background: white; border-radius: 0 0 12px 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); border-top: 1px solid #e9ecef;">

<x-dashboard-layout>
  ...
  <div class="header-section">
    ...
    <!-- Search Form -->
    <form method="GET" action="{{ route('adminApplicationSearch') }}" style="margin-bottom: 24px; padding: 24px; background: white; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">

    ...
    <div class="report-page">
        ...
        <div class="content">
            ...
            <div style="text-align: center; margin: 30px 0;">
                <div style="font-size: 16pt; font-weight: bold; margin-bottom: 5px; line-height: 1pt;">APPLICATION OF GOOD MORAL CHARACTER</div>
                <div style="font-size: 14pt; margin-bottom: 15px; line-height: 1pt;">A.Y. {{ $academic_year }}</div>
                <div style="font-size: 14pt; font-weight: bold; text-decoration: underline; line-height: 1pt;">{{ strtoupper(date('F Y', strtotime($generated_date))) }}</div>
            </div>
